...
function LikedSongs({
  ...
  return (
    <div className="items-center justify-center mx-auto overflow-y-auto">
      ...
      {likedSongsAPI && likedSongsAPI.map((res, i) => {
        return (
          <div className="items-center justify-center flex my-4 w-full text-white shadow-slate-800 hover:bg-slate-800 rounded-3xl hover:scale-105 cursor-pointer transition" 
          onClick={() => {
          ...
          >
            <div className="items-center text-center font-bold">{i+1}</div>
